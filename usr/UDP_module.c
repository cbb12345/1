...
//void TCP_init(void)
//{
//	struct tcp_pcb *TcpPcb;	//定义一个tcp控制块
//	struct ip_addr ipaddr;
//	unsigned short ccc;
//	ccc = g_device.workpara.ReaderPortHigh << 8 ;
//	ccc += g_device.workpara.ReaderPortLow;				//读写器端口号
//	
//	IP4_ADDR(&ipaddr,192,168,0,210);//远程服务器IP，此处为电脑IP
//	
//	TcpPcb = tcp_new();	   		//给tcp控制块分配内存空间    
...
//	
//	tcp_connect(TcpPcb, &ipaddr, 5000, connected);
//}

...
//	Delay(LCD_DELAY);
  ...
  //IP4_ADDR(&gw, 192, 168, 0, 1);
	//绑定源IP,掩码，网关
	IP4_ADDR(&ipaddr,g_device.workpara.ReaderIP1, g_device.workpara.ReaderIP2, g_device.workpara.ReaderIP3,
			   g_device.workpara.ReaderIP4);
	IP4_ADDR(&netmask,g_device.workpara.ReaderNetMask1, g_device.workpara.ReaderNetMask2, g_device.workpara.ReaderNetMask3,
			   g_device.workpara.ReaderNetMask4);
	IP4_ADDR(&gw,g_device.workpara.ReaderGateway1, g_device.workpara.ReaderGateway2, g_device.workpara.ReaderGateway3,
		       g_device.workpara.ReaderGateway4);
#endif

  //Set_MAC_Address(macaddress);
	Set_MAC_Address(&g_device.workpara.ReaderMAC1);
  ...
  /*  Registers the default network interface.注册默认网络接口*/

...
//  RCC_APB1PeriphClockCmd(RCC_APB1Periph_USART2, ENABLE);
  ...
  RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA | RCC_APB2Periph_GPIOB | RCC_APB2Periph_GPIOC |
	...
	RCC_APB1PeriphClockCmd(RCC_APB1Periph_TIM2 | RCC_APB1Periph_TIM3	| RCC_APB1Periph_I2C1 |  
												RCC_APB1Periph_USART2 | RCC_APB1Periph_SPI3 | RCC_APB1Periph_UART4 | 
												RCC_APB1Periph_DAC | RCC_APB1Periph_TIM4, ENABLE);
...
//  ADC_Configuration();
  ...
  SysTick_Config(RCC_Clocks.SYSCLK_Frequency / 1000);//2000);
...
void GPIO_Configuration(void)
{
 ...
 // GPIO_InitStructure.GPIO_Pin = GPIO_Pin_8 | GPIO_Pin_11 |GPIO_Pin_12 | GPIO_Pin_13;
																//GPIO_Pin_5 | GPIO_Pin_8 | GPIO_Pin_11 |
...
//UART4
	...
	//BEEP,WG
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_12 | GPIO_Pin_13 | GPIO_Pin_14 | GPIO_Pin_11 | GPIO_Pin_10;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
...
void NVIC_Configuration(void)
{
  ...
  NVIC_SetVectorTable(NVIC_VectTab_FLASH, 0x3000);//0x9000);//0x3000);//0);
  ...
  NVIC_Init(&NVIC_InitStructure);    
	...
	//输入捕获
	NVIC_InitStructure.NVIC_IRQChannel = UART4_IRQn;//TIM4_IRQn;
	NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = 2;//0;
	NVIC_InitStructure.NVIC_IRQChannelSubPriority = 0;//1;//0;
	NVIC_InitStructure.NVIC_IRQChannelCmd = ENABLE;
	NVIC_Init(&NVIC_InitStructure);
